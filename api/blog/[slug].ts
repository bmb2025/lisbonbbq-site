...
<head>
  ...
  <!-- PostHog — same project/config as the SPA (services/analytics.ts); production host only -->
  <script>
    if (["lisbonbbq.pt","www.lisbonbbq.pt"].includes(location.hostname)) {
      ...
      posthog.init("phc_mfn7B3EMiV3iEDQjRvWWJAREZhdeQs2wSVpAh5WgxuUn", { api_host: "https://eu.i.posthog.com", persistence: "localStorage" });
    }
  </script>
  <style>
